        ...
        <div>
            <div className="max-w-7xl mx-auto">
                ...
                <div className="lg:hidden mb-6">
                    <button className="w-full flex items-center justify-center gap-2 py-3 bg-[#2F80ED] text-white rounded-lg hover:bg-[#2563EB] transition-colors" style={{ height: '48px' }}>
                        <Plus size={20} />
                        Add Client
                    </button>
                </div>

                {/* All Clients Section with Search - Mobile */}
                ...
                <div className="hidden lg:flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center mb-6">
                    ...
                    <div className="flex gap-3">
                        <select className="px-4 py-2 border border-[#D0D5DD] rounded-lg text-[#344054] focus:outline-none focus:ring-2 focus:ring-[#2F80ED]" style={{ height: '48px' }}>
                            ...
                            <option>Total Invoices</option>
                        </select>
                        <button className="flex items-center gap-2 px-4 py-2 bg-[#2F80ED] text-white rounded-lg hover:bg-[#2563EB] transition-colors" style={{ height: '48px' }}>
                            <Plus size={20} />
                            Add Client
                        </button>
                    </div>
                ...
                <div className="bg-white rounded-lg border border-[#E4E7EC] p-12 flex flex-col items-center justify-center">
                    ...
                    <button className="hidden lg:flex items-center gap-2 px-4 py-2 bg-[#2F80ED] text-white rounded-lg hover:bg-[#2563EB] transition-colors" style={{ height: '48px' }}>
                        <Plus size={20} />
                        Add Client
                    </button>
                </div>
