...
export default function ContactUs() {
            ...
            <div className="w-full lg:w-[320px] space-y-[32px] md:space-y-[40px]">
              ...
              <div>
                ...
                <a href="mailto:originalinvoice@gmail.com" className="flex items-center gap-[8px] text-[#2F80ED] text-[14px]">
                  ...
                  <span className="border-b border-[#2F80ED]">Info@originalinvoice.com</span>
                </a>
              </div>
              ...
              <div>
                ...
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-start gap-[8px] text-[#2F80ED] text-[14px]">
                  ...
                  <span className="border-b border-[#2F80ED]">Palm Springs Road, Bele Tower, Lekki Lagos Nigeria</span>
                </a>
              </div>
  ...
  <div className="flex gap-[16px]">
    <a href="https://www.facebook.com/share/1CrpuX8LFN/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] rounded-[8px] flex items-center justify-center hover:bg-[#EFF8FF] hover:text-white transition-colors">
    ...
    <a href="https://www.tiktok.com/@originalinvoice.com?_r=1&_t=ZS-97Fs8KOXxsP" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] rounded-[8px] flex items-center justify-center hover:bg-[#EFF8FF] hover:text-white transition-colors">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
