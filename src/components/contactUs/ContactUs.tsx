...
export default function ContactUs() {
          ...
          <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[60px] xl:gap-[100px] items-start">
            ...
            <div className="w-full lg:w-[320px] space-y-[32px] md:space-y-[40px]">
              ...
              <div>
                ...
                <a href="tel:+2348000000000" className="flex items-center gap-[8px] text-[#2F80ED] text-[14px]">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                  ...
                  <span className="border-b border-[#2F80ED]">+234 (0) 800 000 0000</span>
                </a>
              </div>
  ...
  <div className="flex gap-[16px]">
    <a href="#" className="w-[40px] h-[40px] rounded-[8px] flex items-center justify-center hover:bg-[#EFF8FF] hover:text-white transition-colors">
