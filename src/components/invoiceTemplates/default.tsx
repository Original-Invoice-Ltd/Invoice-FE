      ...
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 sm:p-8 lg:p-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="flex-shrink-0">
            <div className="text-2xl sm:text-3xl font-bold text-gray-800">Logo</div>
          </div>

          {/* Invoice Info */}
          <div className="text-left sm:text-right w-full sm:w-auto">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">INVOICE</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {/* Bill From */}
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-3">Bill From</h3>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-2 text-xs sm:text-sm font-semibold text-gray-600 w-12">#</th>
        ...
        <div className="flex justify-end mb-8 sm:mb-12">
          <div className="w-full sm:w-80 space-y-2">
            ...
            <div className="flex justify-between text-sm py-2 border-t border-gray-200 pt-2">
              ...
              <span className="text-gray-900 font-medium">₦{data.total.toLocaleString()}</span>
            </div>
