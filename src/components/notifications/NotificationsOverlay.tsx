...
const NotificationsOverlay = ({ isOpen, onClose }: NotificationsOverlayProps) => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      type: 'invoice',
      title: 'Invoice sent',
      message: 'Your invoice to Ayo\'s Studio was delivered successfully and is now viewable.',
    ...
    },
    {
      ...
      message: '"Website Design Package" has been added to your items.',
      timestamp: '5 mins ago',
      isRead: false,
      isNew: true
    },
    {
      ...
      message: 'Bright Ventures has been added to your client list.',
    ...
    },
    {
      ...
      type: 'item',
      title: 'Item deleted',
      message: '"Laptop Charger" has been removed from your list.',
      timestamp: 'Yesterday',
      isRead: false,
      isNew: true
    },
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    if (activeTab === 'invoices') return notification.type === 'invoice';
    if (activeTab === 'payment') return notification.type === 'payment';
    if (activeTab === 'client') return notification.type === 'client';
