...
const ReportsHeader = () => {
  ...
  return (
    <div
      className="flex flex-col sm:flex-row sm:items-start mb-6 w-full justify-between"
    >
      ...
      <div className="flex gap-[8px] py-2 md:py-0">
        <button
          className="flex items-center justify-center transition-colors py-4 px-2"
          style={{
            borderRadius: '8px',
            opacity: 1,
            gap: '8px',
