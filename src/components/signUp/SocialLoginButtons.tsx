  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#E5E5E5] 
      ...
      >
        ...
        <span className="text-[#000000] font-medium tracking-[-1px]">Continue with Google</span>
      </button>

      <button
        type="button"
        onClick={handleAppleLogin}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#E5E5E5] rounded-lg transition-colors text-sm sm:text-base"
      >
        ...
        <span className="text-[#000000] font-medium tracking-[-1px]">Continue with Apple</span>
      </button>
    </div>
  );
}
